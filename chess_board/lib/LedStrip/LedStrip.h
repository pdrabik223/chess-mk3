//// Wrapper over FastLED library, simplifies usage and hides implementation done in FastLED library
...
public:
    ...
    /// @param position id of addressed LEDd
...
/// compere two colors whether the're equal
